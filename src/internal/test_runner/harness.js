// https://github.com/nodejs/node/blob/a1b27b25bb01aadd3fd2714e4b136db11b7eb85a/lib/internal/test_runner/harness.js
"use strict";
const {
...
function createProcessEventHandler(eventName, rootTest) {
  return (err) => {
    ...
    if (test.finished) {
      ...
      const msg =
        `Warning: Test "${test.name}" generated asynchronous ` +
