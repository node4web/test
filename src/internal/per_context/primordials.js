...
exports.ArrayPrototypeIncludes = (arr, el, fromIndex) =>
...
exports.ArrayPrototypeReduce = (arr, fn, originalVal) =>
  arr.reduce(fn, originalVal);
...
exports.ArrayPrototypeSplice = (arr, offset, len, ...el) =>
  arr.splice(offset, len, ...el);
...
exports.SafeArrayIterator = class ArrayIterator {
  constructor(array) {
    this.array = array;
  }
  [Symbol.iterator]() {
...
exports.SafeMap = Map;
exports.SafePromiseAll = (array, mapFn) =>
  Promise.all(mapFn ? array.map(mapFn) : array);
exports.SafePromiseAllReturnArrayLike = (array, mapFn) =>
  Promise.all(mapFn ? array.map(mapFn) : array);
exports.SafePromiseRace = (array, mapFn) =>
  Promise.race(mapFn ? array.map(mapFn) : array);
exports.SafeSet = Set;
exports.SafeWeakMap = WeakMap;
exports.SafeWeakSet = WeakSet;
exports.String = String;
exports.StringPrototypeEndsWith = (haystack, needle, index) =>
  haystack.endsWith(needle, index);
exports.StringPrototypeIncludes = (str, needle) => str.includes(needle);
exports.StringPrototypeIndexOf = (str, needle, offset) =>
  str.indexOf(needle, offset);
...
exports.StringPrototypeStartsWith = (haystack, needle, index) =>
...
exports.ReflectApply = (target, self, args) =>
  Reflect.apply(target, self, args);
exports.ReflectConstruct = (target, args, newTarget) =>
  Reflect.construct(target, args, newTarget);
exports.ReflectGet = (target, property, receiver) =>
